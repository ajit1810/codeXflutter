...
class SharedPreferenceHelper {
  ...
  static String userProfileKeys = "USERPROFILEKEY";
  ...
  Future<bool> saveUserProfile(getUserProfile) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userProfileKeys, getUserProfile);
  }
  ...
  Future<String?> getUserProfile() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString(userProfileKeys);
  }
}
